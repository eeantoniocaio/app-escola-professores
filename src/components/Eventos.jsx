...
export default function Eventos({ setView, events, deleteEvent, openEventModal, toggleEventFinalizado }) {
    ...
    <div style={{ animation: 'fadeIn 0.4s ease-out' }}>
      ...
      <div className="eventos-layout" style={{ display: 'block' }}>
        <div className="events-list-container" style={{ width: '100%' }}>
          <div className="controls-panel" style={{ margin: '0 0 1.5rem 0' }}>
            <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
              Total de eventos cadastrados: <strong>{events.length}</strong>
            </span>
          </div>
                ...
                >
                  <div>
                    <div className="event-header">
                      ...
                      <div className="event-actions">
                        <button className="btn-icon" onClick={() => openEventModal(ev)} title="Editar Evento">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                            <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
                          </svg>
                        </button>
                        <button className="btn-icon delete" onClick={() => deleteEvent(ev.id)} title="Excluir Evento">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
                  ...
                  <div className="event-footer" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '0.4rem', borderTop: 'none', paddingTop: '0.5rem' }}>
                    ...
                    <button 
                      ...
                      onClick={() => toggleEventFinalizado(ev.id)}
